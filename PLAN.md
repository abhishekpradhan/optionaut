...
- **M5 (v2) — Sims & sharing:** scenario simulators (IV-crush replay, position-sizing trials), shareable strategy URLs (Lab state encoded in the link), more strategies. (~~Alpaca proxy + caching~~ — killed by D11: redistribution prohibited at every affordable tier.)
